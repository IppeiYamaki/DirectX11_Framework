...
#include "Game/Definitions/Materials/SkyMaterial_Night.h"
...
namespace Game {
    ...
    Engine::GameObject* SkyPrefab_Night::Spawn(Engine::SceneContext& ctx, const SpawnDesc& desc) {
        ...
        // Material
        mr->SetMaterial(ctx.m_materials->GetOrCreate<Game::SkyMaterial_Night>());
