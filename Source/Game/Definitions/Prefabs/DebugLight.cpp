...
namespace Game {
    ...
    Engine::GameObject* DebugLight::Spawn(Engine::SceneContext& ctx, const SpawnDesc& desc) {
        ...
        if (ctx.m_materials) {
            ...
            Engine::Logger::Warn("DebugLight::Spawn: MaterialLibrary is null, creating fallback material.");
        ...
        if (material) {
            ...
            Engine::Logger::Error("DebugLight::Spawn: Failed to create material - rendering will not work!");
        }
