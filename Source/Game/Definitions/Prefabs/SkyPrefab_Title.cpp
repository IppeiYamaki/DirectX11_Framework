...
#include "Game/Definitions/Materials/SkyMaterial_Title.h"

#include "Game/Definitions/Components/SampleRotateComponent.h"

namespace Game {

    Engine::GameObject* SkyPrefab_Title::Spawn(Engine::SceneContext& ctx, const SpawnDesc& desc) {
        ...
        // Material
        mr->SetMaterial(ctx.m_materials->GetOrCreate<Game::SkyMaterial_Title>());
