...
namespace Game {
    ...
    std::shared_ptr<Engine::Material> SkyMaterial::Create(const Engine::MaterialBuildContext& ctx) {
        ...
        auto tex = ctx.m_assets->LoadTexture(L"Textures/Environment/Sky/Sky01.png", opt);
