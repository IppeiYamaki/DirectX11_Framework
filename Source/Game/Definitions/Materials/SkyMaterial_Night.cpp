...
namespace Game {
    ...
    std::shared_ptr<Engine::Material> SkyMaterial_Night::Create(const Engine::MaterialBuildContext& ctx) {
        ...
        auto tex = ctx.m_assets->LoadTexture(L"Textures/Environment/Sky/Sky_Night.png", opt);
