...
// ������ �g�������h �ňˑ������iCore�w�b�_���y���ۂ��߁j
// �� �����̃t�@�C���͎��� Platform/Graphics/Scene ���ō쐬����z��ł�
...
namespace Engine {
    ...
    bool Application::Initialize(const ApplicationSettings& settings) {
        ...
        // �����iCreate�j�Ə������iInitialize�j�͍����Ȃ����j�����A
        // �����ł́u���L���������Initialize���Ăԁv�̂� Application �̐Ӗ��Ƃ���OK�B
        ...
        // --- Window ---
        // �z��: bool Window::Initialize(HINSTANCE, int cmdShow, const std::wstring& title, int w, int h, bool resizable);
        ...
        // --- GraphicsDevice ---
        // �z��: bool GraphicsDevice::Initialize(HWND hwnd, int w, int h, bool vsync);
        ...
        // --- RenderSystem ---
        // �z��: bool RenderSystem::Initialize(GraphicsDevice& device);
    ...
    void Application::Reset() {
        ...
        // RenderSystem/GraphicsDevice �� Reset �͕K�v�ɂȂ�����ǉ�
    }

    int Application::Run(IGame& game) {
        ASSERT(m_isInitialized);

        // Game initialize�iWorld/Assets�Ȃǂ� app �o�R�œn���j
        ...
        while (!m_isQuitRequested) {
            ...
            // �z��: bool Window::PumpMessages(); �ifalse �ŏI���j
            ...
            // �X�V���FGame �� World�i�����E�\��Ȃǂ��ɂ���j
            game.Update(deltaTime);

            if (m_world) {
                m_world->Update(deltaTime);
                m_world->LateUpdate(deltaTime); // World���ɖ����Ȃ��Œ���
            }
            ...
            // ���`��iClear �� Queue���� �� Present�j
            // �z��: void RenderSystem::Draw(World& world);
