...
namespace Engine {
    ...
    bool GraphicsDevice::Initialize(HWND hwnd, int width, int height, bool isVSyncEnabled) {
        ...
        scDesc.BufferCount = 2; // 2������i��Őݒ艻���Ă�OK�j
        scDesc.OutputWindow = m_hWnd;
        scDesc.Windowed = TRUE;
        scDesc.SwapEffect = DXGI_SWAP_EFFECT_DISCARD; // DX11�ŏ��\���i���FLIP�Ɉڍs���Ă�OK�j
        scDesc.Flags = 0;
