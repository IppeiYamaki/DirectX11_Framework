...
namespace Engine {
    ...
    void CameraComponent::SetPerspective(float fovYRadians, float aspect, float nearZ, float farZ) {
        m_fovY = fovYRadians;
        m_aspect = aspect;
        m_nearZ = nearZ;
        m_farZ = farZ;
    ...
    Ray CameraComponent::ScreenPointToRay(float screenX, float screenY, float screenWidth, float screenHeight) const {
    ...
    void CameraComponent::ApplyToRenderSystem() {
